...
movies_path="/mnt/shared_storage/Movies"
...
echo "Scanning for movies with more than $min_subtitle_tracks subtitle tracks in '$movies_path'..."
echo "----------------------------------------------------------------------"

# Find all movie files (MKV, MP4, M4V) and process each one.
# Note: mkvmerge can also read MP4 and other containers, but it's most reliable with MKV.
