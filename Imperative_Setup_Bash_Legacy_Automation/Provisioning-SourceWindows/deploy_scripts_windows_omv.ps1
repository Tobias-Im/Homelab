...
$SourcePath = Join-Path (Split-Path -Parent $PSScriptRoot) "OpenMediaVault"

# We create another variable named $RemoteDir for the destination on the Linux server.
$RemoteDir = "~/Scripts/OMV"
...
Write-Host "OpenMediaVault Script Deployer" -ForegroundColor Cyan
...
Write-Host "4. Run master:      sudo ./main_omv_fresh_install.sh"
Write-Host ""
